...
<html>
	<head>
		...
		<script src="${ctxp}/resources/js/person/personTree.js"></script>
		<script src="${ctxp}/resources/js/notice/notice.js"></script>
			   ...
			   <div class="row">
			       <div class="col-sm-2">
				       <div class="widget-box widget-color-blue2">
					       ...
					       <div class="widget-body" style="overflow:auto;">
					            <div class="widget-main padding-8">
									<div id="personTreeModelDiv" style="height:430px;" data-options="region:'center'">
										<ul id="personTree" class="ztree" style="height:426px;"></ul>
									</div>
								</div>
							</div>	
						</div>	
					...
					<div class="col-sm-10">
				       <div class="widget-box widget-color-blue2">
					       <div class="widget-header">
					       		<h4 class="widget-title lighter smaller">信息发送</h4>
					       </div>
