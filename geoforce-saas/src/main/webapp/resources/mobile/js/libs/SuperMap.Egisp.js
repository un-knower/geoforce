...
SuperMap.Egisp.showPopover = function(string) {      
    jQuery("#popover_content").html(string);
    jQuery("#popover_result").show();
...
SuperMap.Egisp.hidePopover = function() {
    jQuery("#popover_result").hide();    
}

SuperMap.Egisp.timer_hint = null;
SuperMap.Egisp.showHint = function(string) {      
    jQuery("#popover_hint_content").html(string);
    jQuery("#popover_hint").show();
...
SuperMap.Egisp.hideHint = function() {
    jQuery("#popover_hint").hide();    
}
SuperMap.Egisp.showLoading = function(string) {
    jQuery('.mask-loading-text a').html(string);
    jQuery('.mask-loading-text').show();
}
SuperMap.Egisp.hideLoading = function(){
    jQuery('.mask-loading-text').hide();   
    jQuery('.mask-loading-text a').html(''); 
}
...
SuperMap.Egisp.Modal.loading = function(str) {
    ...
    jQuery('.modal-loading .text').html(str);
    jQuery('.modal-loading').show();
}
SuperMap.Egisp.Modal.loaded_right = function(str, callback) {    
    jQuery('.data-modal').hide();
    jQuery('.modal-loaded.modal-right .text').html(str);
    jQuery('.modal-right .btn-save-border').unbind('click').click(callback);
    jQuery('.modal-loaded.modal-right').show();
}
SuperMap.Egisp.Modal.loaded_wrong = function(str, callback) {    
    jQuery('.data-modal').hide();
    jQuery('.modal-loaded.modal-wrong .text').html(str);
    jQuery('.modal-wrong .btn-save-border').unbind('click').click(callback);
    jQuery('.modal-wrong').show();
}
...
SuperMap.Egisp.Modal.ask = function( str, callback, attr, cancel_callback) {
    ...
    jQuery('.modal-ask .btn-save-border')
    .attr(attr)
    .unbind('click').click(callback);

    jQuery('.modal-ask .close').unbind('click').click(function(){
        var me = jQuery(this);
        jQuery(me.attr("data-target")).fadeOut('fast');
        cancel_callback();
    });
    jQuery('.modal-ask .text').html( str );
    jQuery('.modal-ask').show(); 
}
SuperMap.Egisp.Modal.alert = function( str, callback, attr ) {
    ...
    jQuery('.modal-alert .btn-save-border')
    .attr(attr)
    .unbind('click').click(callback);
    jQuery('.modal-alert .text').html( str );
