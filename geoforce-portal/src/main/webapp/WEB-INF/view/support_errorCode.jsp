...
<head>
    ...
    <link rel="stylesheet" href="resource/css/support_errorCode.css">
</head>
...
<div class="main page_wrapper">
    ...
    <div class="centerBar fl">
        <p class="location">当前位置：
            <a href="support_develop.html">帮助与支持 </a>/
            <a class="active">全局错误码</a>
        </p>
...
<script src="resource/js/support_errorCode.js"></script>