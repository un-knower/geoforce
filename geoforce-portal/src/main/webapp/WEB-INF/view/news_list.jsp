            ...
            <li>
                ...
                <div class="li-child4">
                    <ul class="child4-li">
                        ...
                        <li><a href="javascript:void(0);"  data-trigger="focus" data-container="body" data-toggle="popover" data-placement="right"
...
<div class="main page_wrapper">
    ...
    <div class="rightBar fr">
        <p class="location">当前位置：<a href="index.html">首页</a> / <span>平台公告</span></p>
        <ul class="news">
...
<script src="resource/lib/bootstrap/js/bootstrap-paginator.min.js"></script>
