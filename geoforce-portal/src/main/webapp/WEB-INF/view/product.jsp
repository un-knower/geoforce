...
<div class="main page_wrapper">
    ...
    <div class="rightBar" id="myScroll" >
        <ul class="nav">
                <li class="active"><a href="#proIntroduce">产品介绍</a></li>
...
<!--高德地图-->
<script type="text/javascript" src="http://webapi.amap.com/maps?v=1.4.4&key=c6cf3789a16dae9425d781687c9c458c"></script>
<!--bootstrap插件-->
<script type="text/javascript" src="resource/lib/bootstrap/js/bootstrap.min.js"></script>
<!--codemirror-->
<script type="text/javascript" src="resource/lib/codemirror/lib/codemirror.js"></script>
<script type="text/javascript" src="resource/lib/codemirror/mode/xml/xml.js"></script>
<script type="text/javascript" src="resource/lib/codemirror/mode/css/css.js"></script>
<script type="text/javascript" src="resource/lib/codemirror/mode/htmlmixed/htmlmixed.js"></script>
<script type="text/javascript" src="resource/lib/codemirror/mode/javascript/javascript.js"></script>
<script type="text/javascript" src="resource/lib/codemirror/addon/edit/closetag.js"></script>
<script type="text/javascript" src="resource/lib/codemirror/addon/edit/closebrackets.js"></script>

<script type="text/javascript" src="resource/js/common.js"></script>
<script type="text/javascript" src="resource/js/product.js"></script>