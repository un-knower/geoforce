...
<div class="content">
    ...
    <ul class="product-row">
        ...
        <p class="introduce">基于GPS、WIFI的综合定位服务，具有定位精度高，覆盖率广，网络定位请求流量小，定位速度快</p>
        </div>
        </li>
        <li>
        ...
        <p class="introduce">提供业内数据最新最全的矢量地图、卫星图、全景图、实时路况图，静态图和个性化地图服务。</p>
        </div>
        </li>
        <li>
        ...
        <p class="introduce">基于地图丰富的海量数据，开放检索，热词推荐，地理编码等服务，通过LBS云服务。</p>
        </div>
        </li>
    </ul>
    <ul class="product-row">
        ...
        <p class="title">POI检索</p>
        <p class="introduce">提供多类型区划规划方案，各方案还支持多种不同策略的检索面向所以平台提供导航。</p>
        </div>
        </li>
        <li>
        <div class="list-content" style="visibility: visible; animation-duration: 500ms; animation-delay: 200ms; animation-name: none;">
        <img src="resources/img/icon_qyhbm.png" alt="">
        <p class="title">区域面合并</p>
        <p class="introduce">提供轨迹追踪，存储，处理，查询和地理围栏等服务，具有轨迹精准，功耗低，海量终端支持优势。</p>
        </p>
        </div>
        </li>
        <li>
        ...
        <p class="title">空间运算</p>
        <p class="introduce">基于地理大数据，位置大数据，交通大数据和海量数据的地图产品，以领先的大数据分析和可视化技术</p>
        </div>
        </li>
    </ul>
    </div>
