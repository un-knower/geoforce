...
public class ApplicationController {
	...
	public Map<String, Object> query(int first, int max,@RequestParam(defaultValue = "",required = false) String searcher) {
		try {
			//TODO 根据用户ID过滤
			Long total = applicationService.queryCountBySearcher(searcher);
			List<Application> data = applicationService.queryPageBySearcher(first, max,searcher);
