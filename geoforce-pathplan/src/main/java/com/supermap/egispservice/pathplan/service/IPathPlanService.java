...
public interface IPathPlanService {
	 ...
	 * @throws Exception
	 */
	boolean planByVRPPath(String taskId, boolean prohibitViaduct, boolean returnDetail,GroupType groupType,WeightNameType weightNameType,Class clasz  ) throws Exception;
