...
public class CommonUtil {
	 ...
	 */
	public static final Date dateConvert(String dateStr,DateType type)throws AreaException{
		Date date = null;
		try{
			...
			throw new AreaException(ExceptionType.OTHER,"["+dateStr+"]转换异常,转换类型["+type+"");
		}
		return date;
	}
	 ...
	 * @return
	 * Author：Huasong Huang
	 * CreateTime：2014-9-10 上午10:05:32
	 */
