(function() {
    ...
    //加载类库资源文件
    function loadSMLibs() {
        var url = "/egispboss/eboss/";
        inputMyCSS(url + 'libs/bootstrap/bootstrap.min.css');
        inputMyCSS(url + 'libs/bootstrap/bootstrap-multiselect.css');
        inputScript(url + 'libs/jquery/jquery-1.10.2.min.js');
        // inputScript(url + 'libs/jquery/jquery.validate.js');
        // inputScript(url + 'libs/jquery/additional-methods.js');
        ...
        inputScript(url + 'libs/My97DatePicker/WdatePicker.js');
        inputScript(url + 'libs/bootstrap/bootstrap-multiselect.js');
    }
    loadSMLibs(); 
})();
